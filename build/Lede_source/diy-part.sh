...
git clone https://github.com/sylviayiplinda/luci-theme-darkmatter.git package/lean/luci-theme-darkmatter  #暗黑主题
git clone https://github.com/sylviayiplinda/luci-app-jd-dailybonus  #京东签到插件
